...
namespace DoubleEnemies
{
    ...
    {
        public static List<string> Bosses = ["Giant Fly", "Giant Buzzer", "Giant Buzzer Col", "Giant Buzzer Col (1)", "False Knight New",
            "False Knight Dream", "Hornet Boss 1", "Mawlek Body", "Hornet Boss 2", "Fluke Mother", "Mega Fat Bee", "Mega Fat Bee (1)", "Mantis Lord",
            ...
            "Mega Zombie Beam Miner (1)", "Zombie Beam Miner Rematch", "Royal Gaurd", "Royal Gaurd (1)", "Mushroom Brawler 1", "Mage Knight Col",
