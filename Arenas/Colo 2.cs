...
namespace DoubleEnemies
{
    public static partial class Arenas
    {
        public static void Colo2()
        {
            ...
            {
                Satchel.CoroutineHelper.WaitForSecondsBeforeInvoke(3, () =>
                {
                    GameObject.Find("Mega Fat Bee(EnemyDupe)").transform.position = new Vector3(93.3f, 13.14f, 0);
                    GameObject.Find("Mega Fat Bee (1)(EnemyDupe)").transform.position = new Vector3(113.3f, 13.14f, 0);
                });
            });
