...
namespace DoubleEnemies
{
    public static class Watchers
    {
        ...
        {
            GameObject Watcher = GameObject.Find("Black Knight " + s + "(EnemyDupe)");
            PlayMakerFSM fsm = Watcher.LocateMyFSM("Black Knight");

            Watcher.transform.position = GameObject.Find("Black Knight " + s).transform.position + new Vector3(UnityEngine.Random.Range(-1f, 1f), 0, 0);
            fsm.SendEvent("WAKE");
        }
    }
}